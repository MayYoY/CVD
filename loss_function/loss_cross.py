...
class Cross_loss(nn.Module):
    ...
    def forward(self, feat_hr, feat_n, hr, feat_hrf1, feat_nf1, hrf1, idx1, feat_hrf2, feat_nf2, hrf2, idx2, gt):
        ...
        :param feat_nf1:
        :param hrf1:
        :param idx1: feature1 的真正下标
        :param feat_hrf2:
        :param feat_nf2:
        :param hrf2:
        :param idx2: feature2 的真正下标
        :param gt:
        :return:
        """
        ...
        loss = self.lambda_hr * (loss_hr1 + loss_hr2) / 2 + self.lambda_fhr * (
                    loss_fhr1 + loss_fhr2) / 2 + self.lambda_fn * (loss_fn1 + loss_fn2) / 2
