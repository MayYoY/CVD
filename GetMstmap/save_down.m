function save_down(HR_train_path, SignalMap, BVP_all, gt, fps, clip_length)
    ...
    for i = 1:clip_num
        ...
        % 下采样 clip 会导致 hr 上升, 排除合理区间外的 clip (between 60 bpm and 110 bpm)
        if gt_temp > 110 || gt_temp < 60
            continue;
        end
